/obj/item/camera_assembly
	...
	var/list/obj/item/possible_upgrades = list(/obj/item/device/assembly/prox_sensor, /obj/item/stack/sheet/mineral/plasma, /obj/item/reagent_containers/food/snacks/grown/carrot)

...
/proc/Broadcast_Message(var/datum/radio_frequency/connection, var/mob/M,
						...
						var/data, var/compression, var/list/level, var/freq, var/verbage = "says", var/datum/language/speaking = null, var/ending = copytext_char(message, length(message)))
  ...
  /* ###### Begin formatting and sending the message ###### */
	if (length(heard_masked) || length(heard_normal) || length(heard_voice) || length(heard_garbled) || length(heard_gibberish))
	  ...
	  /* --- Some miscellaneous variables to format the string output --- */
		var/part_a = "<span class='comms'><span class='commsname'>" // goes in the actual output
		if(!(ishuman(M)))
			part_a = "<span class='bname'><span class='bname'>" // goes in the actual output
		...
		if(!freq_text)
			freq_text = M.job//format_frequency(display_freq)
		...
		if (display_freq == SYND_FREQ)
			part_a = "<span class='syndradio'><span class='commsname'>"

		// centcomm channels (deathsquid and ert)
		else if (display_freq in CENT_FREQS)
			part_a = "<span class='centradio'><span class='commsname'>"

		// command channel
		else if (display_freq == COMM_FREQ)
			part_a = "<span class='commsnob'><span class='commsname'>"

		// department radio formatting (poorly optimized, ugh)
		else if (display_freq == SEC_FREQ)
			part_a = "<span class='commsgar'><span class='commsname'>"

		else if (display_freq == ENG_FREQ)
			part_a = "<span class='commsinq'><span class='commsname'>"

		else if (display_freq == SCI_FREQ)
			part_a = "<span class='sciradio'><span class='commsname'>"

		else if (display_freq == MED_FREQ)
			part_a = "<span class='medradio'><span class='commsname'>"

		else if (display_freq == SUP_FREQ) // cargo
			part_a = "<span class='supradio'><span class='commsname'>"

		// If all else fails and it's a dept_freq, color me purple!
		else if (display_freq in DEPT_FREQS)
			part_a = "<span class='comms'><span class='commsname'>"

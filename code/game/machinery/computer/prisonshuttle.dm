...
/obj/machinery/computer/prison_shuttle
	...
	attack_hand(var/mob/user as mob)
		...
		if (src.temp)
			...
			\nLocation: [prison_shuttle_moving_to_station || prison_shuttle_moving_to_prison ? "Moving ([prison_shuttle_timeleft] Secs.)":prison_shuttle_at_station ? "[vessel_type]":"Dock"]<BR>
			[prison_shuttle_moving_to_station || prison_shuttle_moving_to_prison ? "\n*Shuttle already called*<BR>\n<BR>":prison_shuttle_at_station ? "\n<A href='?src=\ref[src];sendtodock=1'>Send to Dock</A><BR>\n<BR>":"\n<A href='?src=\ref[src];sendtostation=1'>Send to [vessel_type]</A><BR>\n<BR>"]

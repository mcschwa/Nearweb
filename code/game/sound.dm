...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("shovel") soundin = pick('sound/weapons/shovel_hit1.ogg','sound/weapons/shovel_hit2.ogg','sound/weapons/shovel_hit3.ogg')
			if ("shovelswing") soundin = pick('sound/weapons/shovel_swing1.ogg', 'sound/weapons/shovel_swing2.ogg')
			...
			if ("balls") soundin = pick('sound/voice/balls1.ogg','sound/voice/balls2.ogg')

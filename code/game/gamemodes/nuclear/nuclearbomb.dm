...
/obj/machinery/nuclearbomb
	...
	use_power = 0
	flammable = 0
	var/obj/effect/bomblight = null



/obj/effect/bomblight
	name = "bomb light"
	icon = 'icons/obj/nbomb.dmi'
	icon_state = "nukeL"
	layer = 21
...
/obj/machinery/nuclearbomb/New()
	...
	w -= src.safety_wire
	var/obj/effect/bomblight/L = new()
	L.color = "#FF0000"
	L.alpha = 150
	src.bomblight = L
	L.set_light(2,2,"#FF0000")
	overlays += L
	var/newstep = get_step(src, WEST)
	new /obj/structure/decor/fakebomb(newstep)

/obj/machinery/nuclearbomb/process()
	if (src.timing)
		bomb_set = 1 //So long as there is one nuke timing, it means one nuke is armed.
		src.timeleft--
		playsound(src.loc, 'sound/weapons/BEEP.ogg', 60, 0, 0)
		if (src.timeleft <= 0)
			explode()

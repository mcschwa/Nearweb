/datum/job/southner
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)
			return 0
		..()
		H.my_skills.change_skill(SKILL_MELEE,rand(3,7))
		H.my_skills.change_skill(SKILL_RANGE,rand(3,7))
		H.my_skills.change_skill(SKILL_UNARM,rand(0,10))
		H.my_skills.change_skill(SKILL_CLIMB,rand(5,5))
		...
		switch(pick(class))
			...
			if("Machingunner")
				H.equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/carbine(H), slot_r_hand)
			...
			if("Pistolier")
				...
				H.equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/pistol/magnum66/screamer23(H), slot_r_hand)

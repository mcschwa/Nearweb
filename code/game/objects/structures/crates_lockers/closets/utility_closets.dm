...
/obj/structure/closet/medical_wall/random //medical closet with random medical supplies
	...
	New()
		...
		if(prob(20)) new/obj/item/reagent_containers/pill/antitox(src)
		if(prob(20)) new/obj/item/stack/medical/splint(src)
		if(prob(20)) new/obj/item/reagent_containers/hypospray/medipen(src)
		if(prob(10)) new/obj/item/reagent_containers/pill/epinephrine(src)
		if(prob(5)) new/obj/item/tank/anesthetic(src)
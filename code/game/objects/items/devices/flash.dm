...
//								revsafe = 2
							if(!revsafe)
								...
								M.flash_integralist_pain()
								to_chat(M, "\blue You are a member of the integralist revolutionaries!")
								M << sound('sound/music/liberty.ogg', repeat = 0, wait = 0, volume = 70, channel = 3)
							else if(revsafe == 1)

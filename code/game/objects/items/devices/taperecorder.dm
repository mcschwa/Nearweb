...
/obj/item/device/taperecorder/RightClick(mob/living/carbon/human/user)

	if(user.get_active_hand() == null || istype(user.get_active_hand(), /obj/item/device/taperecorder))
...
/obj/item/device/taperecorder/attack_self(mob/user)
	if(recording == 0 && playing == 0)
		...
		icon_state = "taperecorderrecording"
		if(timerecorded < 3600 && playing == 0)
			visible_message("<span class='passiveboldsmaller'>[uppertext(src.name)]</span> <span class='passivesmaller'>GRAVAÇÃO INICIADA.</span>")
			playsound(src.loc, 'sound/VOUSUARDAQUIAPOCO/console_success.ogg', 30, 1)
			recording = 1
			timestamp+= timerecorded
			storedinfo += "\[[time2text(timerecorded*10,"mm:ss")]\] Recording started."
			for(timerecorded, timerecorded<3600)
		...
		if(recording == 1)
			...
			timestamp+= timerecorded
			storedinfo += "\[[time2text(timerecorded*10,"mm:ss")]\] Recording stopped."
			playsound(src.loc, 'sound/VOUSUARDAQUIAPOCO/slots_slot_stop1.ogg', 30, 1)
			visible_message("<span class='passiveboldsmaller'>[uppertext(src)]</span> <span class='passivesmaller'>GRAVAÇÃO ENCERRADA.</span>")
			icon_state = "taperecorderidle"
			return
		else if(playing == 1)
			playing = 0
...
D:::::::::::::::DD                      l:::::l
DDD:::::DDDDD:::::D                     l:::::l
  D:::::D    D:::::D     eeeeeeeeeeee    l::::l uuuuuu    uuuuuu  xxxxxxx      xxxxxxx eeeeeeeeeeee
  D:::::D     D:::::D  ee::::::::::::ee  l::::l u::::u    u::::u   x:::::x    x:::::xee::::::::::::ee
  D:::::D     D:::::D e::::::eeeee:::::eel::::l u::::u    u::::u    x:::::x  x:::::xe::::::eeeee:::::ee
  D:::::D     D:::::De::::::e     e:::::el::::l u::::u    u::::u     x:::::xx:::::xe::::::e     e:::::e
  D:::::D     D:::::De:::::::eeeee::::::el::::l u::::u    u::::u      x::::::::::x e:::::::eeeee::::::e
  D:::::D     D:::::De:::::::::::::::::e l::::l u::::u    u::::u       x::::::::x  e:::::::::::::::::e
  D:::::D     D:::::De::::::eeeeeeeeeee  l::::l u::::u    u::::u       x::::::::x  e::::::eeeeeeeeeee
  D:::::D    D:::::D e:::::::e           l::::l u:::::uuuu:::::u      x::::::::::x e:::::::e
DDD:::::DDDDD:::::D  e::::::::e         l::::::lu:::::::::::::::uu   x:::::xx:::::xe::::::::e
D:::::::::::::::DD    e::::::::eeeeeeee l::::::l u:::::::::::::::u  x:::::x  x:::::xe::::::::eeeeeeee
D::::::::::::DDD       ee:::::::::::::e l::::::l  uu::::::::uu:::u x:::::x    x:::::xee:::::::::::::e
DDDDDDDDDDDDD            eeeeeeeeeeeeee llllllll    uuuuuuuu  uuuuxxxxxxx      xxxxxxx eeeeeeeeeeeeee
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣧⠀⠀⠀⠀⠀⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣿⣧⠀⠀⠀⢰⡿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⡟⡆⠀⠀⣿⡇⢻⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⠀⣿⠀⢰⣿⡇⢸⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀

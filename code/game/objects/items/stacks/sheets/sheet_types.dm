...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	new/datum/stack_recipe("wooden sandals", /obj/item/clothing/shoes/lw/sandal, 1), \
	new/datum/stack_recipe("wooden door", /obj/structure/mineral_door/wood, 3, time = 20, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("coffin", /obj/structure/closet/coffin, 3, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("bed", /obj/structure/stool/bed, 3, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wood rack", /obj/structure/rack, 2, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("crude wooden table", /obj/structure/rack/lwtable/table3, 3, time = 15, one_per_turf = 1, on_floor = 1), \
...
/obj/item/stack/sheet/wood/full
	amount = 5

/obj/item/stack/sheet/wood/attack_self(mob/user as mob)
	return

/obj/item/stack/sheet/wood/update_icon()
	icon_state = "shroomlog[amount]"
	if(amount == 1)
		weight = 14
		item_worth = 6
	if(amount == 2)
...
/obj/item/stack/sheet/wood/add_to_stacks(mob/usr as mob)
	..()
	update_icon()
	if(amount == 1)
		weight = 14
...
/obj/item/stack/sheet/wood/New(var/loc, var/A=0)

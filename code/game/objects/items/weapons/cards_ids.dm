...
/obj/item/card/id/proc/receivePayment(var/amount)
...
/obj/item/card/id/heir
	name = "heir's ring"
	icon_state = "id_heir"
	item_state = "card-id"

/obj/item/card/id/baroness
...
/obj/item/card/id/mortician
	name = "ring"
	icon_state = "id_engie"
	item_state = "card-id"
	color = "gray"

/obj/item/card/id/other
	name = "common ring"
	icon_state = "id_other"
	item_state = "card-id"
...
/obj/item/card/id/family
	name = "ring"
	icon_state = "family"

/obj/item/card/id/family/tribunal
	New()
		access = list()
		var/datum/job/captain/J = new/datum/job/captain
		access = J.get_access()

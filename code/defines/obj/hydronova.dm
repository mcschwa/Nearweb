...
/obj/item/seedsn
	...
	var/species = ""
	var/maxstate = 3
	var/product = /obj/item/reagent_containers/food/snacks/grown/potato
...
/obj/item/seedsn/weed
	icon_state = "wheat"
	product = /obj/item/reagent_containers/food/snacks/grown/weed
	maxstate = 2
...
/obj/item/seedsn/sweetpod
	species = "sweetpod"
	icon_state = "sweetpod"
	product = /obj/item/reagent_containers/food/snacks/grown/sweetpod
	maxstate = 3

/obj/item/seedsn/pigtail
	icon_state = "pigtail"
	product = /obj/item/reagent_containers/food/snacks/grown/pigtail
	maxstate = 3

/obj/item/seedsn/beet
	icon_state = "beet"
	product = /obj/item/reagent_containers/food/snacks/grown/beet
	maxstate = 3

/obj/item/seedsn/turnip
	icon_state = "turnip"
	product = /obj/item/reagent_containers/food/snacks/grown/turnip
	maxstate = 3
...
/obj/item/seedsn/gryab
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/gryab
	maxstate = 3
	species = "gryab"

/obj/item/seedsn/podgnylnik
	species = "podgnylnik"
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/podgnylnik
	maxstate = 3

/obj/item/seedsn/angel
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/ljutogreeb
	maxstate = 3
	species = "curer"

/obj/item/seedsn/libertycap
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/otorvyannik
	maxstate = 3

/obj/item/seedsn/ovrajnik
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/ovrajnik
	maxstate = 3
	species = "fshroom"

/obj/item/seedsn/slezjak
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/slezjak
	maxstate = 3
	species = "eshroom"

/obj/item/seedsn/zelegreeb
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/zelegreeb
	maxstate = 3
	species = "cshroom"

/obj/item/seedsn/bezglaznik
	species = "bezglaznik"
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/bezglaznik
	maxstate = 3

/obj/item/seedsn/barhovik
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/barhovik
	maxstate = 3
	species = "dshroom"

/obj/item/seedsn/krovnik
	species = "krovnik"
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/krovnik
	maxstate = 3
	species = "krovnik"

/obj/item/seedsn/corniy
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/corniy
	maxstate = 3
	species = "ashroom"

/obj/item/seedsn/zheleznyak
	product = /obj/item/reagent_containers/food/snacks/grown/mushroom/zheleznyak
	maxstate = 3
	species = "bshroom"
...
/turf/simulated/floor/plating/dirt2/examine(mob/user)
	..()
	if(!ishuman(user))
		return
	var/mob/living/carbon/human/H = user
	if(plantgrowing.weed)
		to_chat(user, "<br><span class='combatbold'>This soil is infested with <b>maggots.</b></span>")
...
/obj/item/ore/dirt/attackby(obj/item/C, mob/user)
...
/turf/simulated/floor/plating/dirt2/attackby(obj/item/C, mob/user)
	...
	if(istype(C, /obj/item/seedsn))
		plant_seed(C,user)
	if(istype(C, /obj/item/reagent_containers/food/snacks/grown/potato))
	...
	if(istype(C, /obj/item/shovel))
		...
		if(S.contents.len)
			...
			if(D.diggability > 1)
				var/obj/item/ore/dirt/chao = new(user.loc)
				S.contents += chao
				chao.loc = S
				D.diggability -= 1
	...
	if(istype(C,/obj/item/reagent_containers/food/snacks/poo))
	...
	if(istype(C,/obj/item/reagent_containers/food/snacks/bone))
		if(jacresciumavez - 1 <= -2)
			jacresciumavez = -2
			return
		jacresciumavez--
	...
	if(istype(C, /obj/item/reagent_containers))
		var/obj/item/reagent_containers/R = C

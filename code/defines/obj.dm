...
/obj/structure/lfwindow
	var/closed = 0
	var/icon_open = "fort1"
	var/icon_closed = "fortclosed"
	var/turf/simulated/wall/wall = null
	plane = 21

/obj/structure/lfwindow/New()
	..()
...
/obj/structure/lfwindow/update_icon()
	if(closed)
...
/obj/structure/lfwindow/RightClick(mob/living/carbon/human/user as mob)
	..()
	if(get_dist(src,user) >= 2)
		return
	if(closed)
		playsound(src.loc, 'sound/effects/drsc_wardrobe_close_01.ogg', 80, 1)
		closed = FALSE
	else
		playsound(src.loc, 'sound/effects/drsc_wardrobe_open_02.ogg', 80, 1)
		closed = TRUE
	update_icon()
...
/obj/structure/lfwindow/woodenopen
	name = "wooden window"
...
/obj/structure/lfwindow/stonewindow/green
	color = "#475241"

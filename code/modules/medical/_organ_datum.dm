//datum base de orgao
//vai virar objeto depois isso e mto cringe
/datum/organ
	var/name = "organ"
	...
	for(var/datum/organ/external/E in bad_external_organs)
		...
		if(!E.need_process())
			...
			//Moving around with fractured ribs won't do you any good
				if (E.is_broken() && E.internal_organs && prob(15) && (!(istype(E, /datum/organ/external/head) && E:brained)))
					var/datum/organ/internal/I = pick(E.internal_organs)
					custom_pain("<span class='combat'>You feel broken bones moving in your [E.display_name]!</span>", 1)

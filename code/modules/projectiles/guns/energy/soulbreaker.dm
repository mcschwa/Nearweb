/obj/item/gun/energy/taser/MERCY
...
/obj/item/gun/energy/taser/MERCY/Fire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, params, reflex = 0)
	if(mode)
		..()
		sleep(1)
		..()
...
/obj/item/gun/energy/taser/MERCY/soulbreaker
...
/obj/item/gun/energy/taser/MERCY/pistol

...
/obj/item/gun/energy/taser/leet
	name = "Isaac-HH"
	...
	attackby(var/obj/item/A, var/mob/user)
		if(istype(A, /obj/item/cell/crap) && !power_supply)
...
/obj/item/gun/energy/taser/leet/sparq
	name = "Sparq beam"
...
/obj/item/gun/energy/taser/leet/noctis
	name = "Noctis-09"
	jam_chance = 0 // VAI TOMAR NO CU COMICAO, TASER NÃO DÁ JAMMMMMMMMMMMMM
	explode_chance = 1
	is_exploding = 0
...
/obj/item/gun/energy/taser/leet/maulet
	name = "Maulet P2R"
	jam_chance = 0 // VAI TOMAR NO CU COMICAO, TASER NÃO DÁ JAMMMMMMMMMMMMM
	explode_chance = 1
	is_exploding = 0
...
/obj/item/gun/energy/taser/leet/legax
...
/obj/item/gun/energy/taser/leet/laser
	name = "6B-Lasgun"
...
/obj/item/gun/energy/taser/leet/laser/New()
	..()
	var/obj/item/cell/crap/leet/L = new(src)
	power_supply = L
	power_supply.loc = src

/obj/item/gun/energy/taser/leet/legax/attack_self(mob/living/user)
	. = ..()
	if(user.r_hand == src || user.l_hand == src)
		if(istype(projectile_type, /obj/item/projectile/energy/legax))

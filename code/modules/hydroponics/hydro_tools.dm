...
/obj/item/device/analyzer/plant_analyzer/afterattack(obj/target, mob/user, flag)
	...
	if(grown_seed.biolum_colour)
		dat += "<br>It is bio-luminescent."//[grown_seed.biolum_colour ? "<font color='[grown_seed.biolum_colour]'>bio-luminescent</font>" : "bio-luminescent"]

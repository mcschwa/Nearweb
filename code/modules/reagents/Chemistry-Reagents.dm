...
/datum/reagent/proc/reaction_mob(var/mob/M, var/method=TOUCH, var/volume, var/target_zone) //By default we have a chance to transfer some
...
datum/reagent/proc/reaction_turf(var/turf/T, var/volume, var/shouldNull = 1)
	if(shouldNull)
		src = null
	return
...
datum/reagent/water
	...
	reagent_state = LIQUID
	color = WATER_COLOR // rgb: 0, 100, 200
	...
	on_mob_life(var/mob/living/M as mob)
		if(ishuman(M))
			if((M.mind in ticker.mode.cult) && prob(10))
				to_chat(M, "\blue A cooling sensation from inside you brings you an untold calmness.")
...
datum/reagent/toxin/plantbgone
	...
	reaction_obj(var/obj/O, var/volume)
		if(istype(O,/obj/structure/stool/bed/weeds/))
			var/obj/structure/stool/bed/weeds/alien_weeds = O
...
datum/reagent/drink/reaction_mob(var/mob/living/M as mob, var/method=INGEST, var/volume)
	M.bladder += nutriment_factor/2
	..()
	return
...
datum/reagent/ethanol
	...
	var/confused_start = 400	//amount absorbed after which mob starts confusing directions
	var/blur_start = 500	//amount absorbed after which mob starts getting blurred vision
	var/pass_out = 600	//amount absorbed after which mob starts passing out
	flammable = 1
...
datum/reagent/ethanol/vodka
	name = "Vodka"
	id = "vodka"
	description = "Number one drink AND fueling choice for Salarians."
	color = "#bfc0ee" // rgb: 0, 100, 200
	boozepwr = 2

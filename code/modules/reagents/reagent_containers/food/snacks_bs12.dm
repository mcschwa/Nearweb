...
/obj/item/reagent_containers/food/snacks/ketchup
	name = "ketchup"
...
/obj/item/reagent_containers/food/snacks/sweetapple
	name = "sweet apple"
...
/obj/item/reagent_containers/food/snacks/smeatspaghetti
...
/obj/item/reagent_containers/food/snacks/scheeseburger
...
/obj/item/reagent_containers/food/snacks/flatdough/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/kitchen/utensil/knife))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/doughslice(spawnloc)
		new /obj/item/reagent_containers/food/snacks/doughslice(spawnloc)
		new /obj/item/reagent_containers/food/snacks/doughslice(spawnloc)
...
/obj/item/reagent_containers/food/snacks/potato/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/kitchen/utensil/knife))
		var/turf/spawnloc = foodloc(user, src)
...
/obj/item/reagent_containers/food/snacks/breadsys/ontop/bread/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/butter))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/butterbread(spawnloc)
		user << "You place butter on the bread."
		qdel(W)
		qdel(src)

/obj/item/reagent_containers/food/snacks/breadsys/ontop/butterbread/attackby(obj/item/W as obj, mob/user as mob)
	var/turf/spawnloc = foodloc(user, src)

	// Bread and butter + cheese slice = cheese sandwich
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese))
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/chsandwich(spawnloc)
	...
	// Bread and butter + cutlet = meat sandwich
		...
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/msandwich(spawnloc)
		user << "You make a meat sandwich."
		qdel(W)
		qdel(src)

	else if(istype(W, /obj/item/reagent_containers/food/snacks/breadsys/ontop/salami))
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/salsandwich(spawnloc)
...
/obj/item/reagent_containers/food/snacks/breadsys/ontop/chsandwich/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/msandwich))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/sammich(spawnloc)
		user << "You make a sammich,"
		qdel(W)
		qdel(src)

// Meat sandwich + cheese sandwich = sammich
/obj/item/reagent_containers/food/snacks/breadsys/ontop/msandwich/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/chsandwich))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/sammich(spawnloc)
		user << "You make a sammich,"
		qdel(W)
...
/obj/item/reagent_containers/food/snacks/burger/attackby(obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/cheeseburger(spawnloc)
...
/obj/item/reagent_containers/food/snacks/hamburger/attackby(obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/cheeseburger(spawnloc)
		user << "You make a cheeseburger."
...
/obj/item/reagent_containers/food/snacks/sburger/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/scheeseburger(spawnloc)
		user << "You make a sauced cheeseburger."
		qdel(W)
		qdel(src)

// Sauced hamburger + cheese slice = sauced cheeseburger
/obj/item/reagent_containers/food/snacks/shamburger/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/scheeseburger(spawnloc)
		user << "You make a sauced cheeseburger."
...
// Steak + ketchup
/obj/item/reagent_containers/food/snacks/steak/attackby(obj/item/reagent_containers/food/snacks/ketchup/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
...
/obj/item/reagent_containers/food/snacks/bakedpotato/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/ketchup))
		var/turf/spawnloc = foodloc(user, src)
...
// Spaghetti + ketchup
/obj/item/reagent_containers/food/snacks/spaghetti/attackby(obj/item/reagent_containers/food/snacks/ketchup/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/sspaghetti(spawnloc)
...
// Burger + ketchup
/obj/item/reagent_containers/food/snacks/burger/attackby(obj/item/reagent_containers/food/snacks/ketchup/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
...
// Hamburger + ketchup
/obj/item/reagent_containers/food/snacks/hamburger/attackby(obj/item/reagent_containers/food/snacks/ketchup/W as obj, mob/user as mob)
	if(istype(W))
		var/turf/spawnloc = foodloc(user, src)
...
// the loaf
/obj/item/reagent_containers/food/snacks/breadsys/
	icon_state = null



// the loaf
/obj/item/reagent_containers/food/snacks/breadsys/loaf
	name = "loaf of bread"
...
// the head of cheese
/obj/item/reagent_containers/food/snacks/breadsys/bigcheese
	name = "cut of cheese"
...
/obj/item/reagent_containers/food/snacks/breadsys/ontop
	var/stateontop = "salami3" //state when ontop a sandvich

// a slice of bread loaf
/obj/item/reagent_containers/food/snacks/breadsys/ontop/bread
	name = "bread slice"
...
// a slice of cheese
/obj/item/reagent_containers/food/snacks/breadsys/ontop/cheese
	name = "cheese slice"
...
// bread and butter
/obj/item/reagent_containers/food/snacks/breadsys/ontop/butterbread
...
// a cheese sandwich
/obj/item/reagent_containers/food/snacks/breadsys/ontop/chsandwich
...
// a meat sandwich
/obj/item/reagent_containers/food/snacks/breadsys/ontop/msandwich
	name = "meat sandwich"
...
// a salami sandwich
/obj/item/reagent_containers/food/snacks/breadsys/ontop/salsandwich
...
// a sammich
/obj/item/reagent_containers/food/snacks/breadsys/ontop/sammich
	name = "sammiich"
...
//	 Loaf code
/obj/item/reagent_containers/food/snacks/breadsys/loaf/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/kitchen/utensil/knife))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/bread(spawnloc)
...
//	 Salami code
/obj/item/reagent_containers/food/snacks/breadsys/salamistick/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/kitchen/utensil/knife))
		var/turf/spawnloc = foodloc(user, src)
		new /obj/item/reagent_containers/food/snacks/breadsys/ontop/salami(spawnloc)
...
//	 Butterpack code
/obj/item/reagent_containers/food/snacks/breadsys/butterpack/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/kitchen/utensil/knife))
		var/turf/spawnloc = foodloc(user, src)
		if(amount >= 1)
			new /obj/item/reagent_containers/food/snacks/breadsys/ontop/butter(spawnloc)
...
/obj/item/reagent_containers/food/snacks/breadsys/bread/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/reagent_containers/food/snacks/breadsys/ontop))
		...
		src.heal_amt++
	else if(W.type == /obj/item/reagent_containers/food/snacks/breadsys/bread/)
		user.drop_item(W)
		W.loc = src
		if(src.name != "sandwich")
			src.name = "sandwich"
...
/obj/item/reagent_containers/food/snacks/breadsys/bread/update_icon()
	src.overlays = null
	var/num = amount
	for(var/obj/item/reagent_containers/food/snacks/breadsys/ontop/X in src)
...
/obj/item/reagent_containers/food/snacks/candy/MouseDrop(mob/user as mob)
...
/obj/item/reagent_containers/food/snacks/chips/MouseDrop(mob/user as mob)
	return src.attack(user, user)
...
/obj/item/reagent_containers/food/snacks/waffles/MouseDrop(mob/user as mob)
	return src.attack(user, user)

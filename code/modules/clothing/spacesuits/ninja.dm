...
/obj/item/clothing/suit/space/space_ninja
	...
	allowed = list(/obj/item/gun,/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/melee/baton,/obj/item/handcuffs,/obj/item/tank,/obj/item/cell)
	slowdown = 0
	...
	var/reagent_list[] = list("omnizine","salbutamol","spaceacillin","charcoal","nutriment","radium","pen_acid")//The reagents ids which are added to the suit at New().

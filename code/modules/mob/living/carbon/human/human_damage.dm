...
/mob/living/carbon/human/apply_damage(var/damage = 0, var/damagetype = BRUTE, var/def_zone = null, var/armor = 0, var/sharp = 0, var/edge = 0, var/obj/used_weapon = null, var/specialAttack)

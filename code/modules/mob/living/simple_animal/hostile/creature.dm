/mob/living/simple_animal/hostile/retaliate/creature
	name = "Khor-Khor"
...
/mob/living/simple_animal/hostile/retaliate/creature/New()
	src.name = "[pick("Khor-Khor","Strygh","Gwon-Gwon")]"
	..()

/mob/living/simple_animal/hostile/retaliate/creature/Move()
	..()
	if(stat != 0)
		return
	if(prob(10))
...
/mob/living/simple_animal/hostile/retaliate/creature/Retaliate()
	..()
	//src.visible_message("<span class='combatbold'> [src]</span> <span class='combat'>looks alert.</span>")

/mob/living/simple_animal/hostile/retaliate/creature/ListTargets()
	return view(10, src) - src

/mob/living/simple_animal/hostile/retaliate/creature/attackby(var/obj/item/O as obj, var/mob/user as mob)  //Marker -Agouri

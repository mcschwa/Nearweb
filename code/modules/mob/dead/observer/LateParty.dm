...
/mob/dead/observer/verb/lateparty()
	...
	if(latepartied_list.len >= LATEPARTY_MAX)
		...
		to_chat(usr, "<span class='bname'>[latepartied_list.len]/4 ready</span>")
		check_late_party()
		return 1
...
/proc/check_late_party()
	if(latepartied_list.len >= LATEPARTY_MAX)
		...
		switch(whatLateParty)
			...
			if("cerberii")
				possiblefates = list("Tiamat", "Tiamat", "Tiamat", "Tiamat", "Tiamat", "Tiamat")
			if("inquis")
		...
		while(candidatos.len)
			...
			switch(chosen)
				if("Father1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/gun/projectile/newRevolver/duelista(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/stack/bullets/Newduelista/three(new_character), slot_r_store)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/capelp(new_character), slot_back)
					...
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_r_hand)
					new_character.equip_to_slot_or_del(new /obj/item/card/id/family(new_character), slot_wear_id)
				...
				if("Heir1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/leatherboots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/leja(new_character), slot_wear_suit)
					new_character.equip_to_slot_or_del(new /obj/item/claymore/rusty(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/stack/bullets/Newduelista/three(new_character), slot_r_store)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/capelp(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/wrist/bracer(new_character), slot_wrist_r)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/wrist/bracer(new_character), slot_wrist_l)
		...
		// SOULBREAKER
				if("Bashar1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/card/id/ltgrey(new_character), slot_wear_id)
			...
			// COUNTESS
				if("Countess1")
					...
					if(!countess)
						...
						if(new_character.gender == FEMALE)
							...
							new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/minisatchelchurch2(new_character), slot_back)
							if(new_character.back)
								new_character.equip_to_slot_or_del(new /obj/item/reagent_containers/glass/bottle/lifeweb/widowtear(new_character.back), slot_in_backpack)
						else
							...
							new_character.equip_to_slot_or_del(new /obj/item/claymore/rapier(new_character), slot_r_hand)
				...
				if("Sieger1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_l_hand)
				...
				if("Gink1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/claymore/tribal_spear(new_character), slot_r_hand)
				...
				if("Counthandgift")
					var/mob/living/carbon/human/new_character = new(pick(latejoin))
					if(donation_trap.Find(ckey(OO.client.key)))
						new_character.gender = pick(MALE,FEMALE)
					else
						new_character.gender = MALE
					new_character.key = OO.key
					...
					new_character.equip_to_slot_or_del(new /obj/item/claymore/bastard(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/lantern/on(new_character), slot_l_hand)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/under/common(new_character), slot_w_uniform)
				...
				if("Thanati1")
					...
					switch(swordtype)
						...
						if("club")
							new_character.equip_to_slot_or_del(new /obj/item/melee/classic_baton/club, slot_belt)
							new_character.my_skills.change_skill(SKILL_SWING, 3)
						if("bardiche")
							new_character.equip_to_slot_or_del(new /obj/item/claymore/bardiche(new_character), slot_r_hand)
							new_character.my_skills.change_skill(SKILL_STAFF, 3)
						if("spear")
							new_character.equip_to_slot_or_del(new /obj/item/claymore/spear(new_character), slot_r_hand)
							new_character.my_skills.change_skill(SKILL_STAFF, 3)
				...
				if("ThanatiLeader")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/merc_boots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/new_rifle/thanatikabal(new_character), slot_back)
				...
				if("Thanatibomber")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/thanati/thanatilateparty(new_character), slot_wear_suit)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/merc_boots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/beltsatchelthanati/bomb(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/minisatchel/satchelthanati(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/flame/lighter/zippo(new_character), slot_l_store)
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_l_hand)
					new_character.my_skills.change_skill(SKILL_MELEE,rand(9,12))
					new_character.my_skills.change_skill(SKILL_RANGE,rand(9,12))
					new_character.my_skills.change_skill(SKILL_SURG,rand(6,9))
				...
				if("SirVandenberg")
					...
					new_character.equip_to_slot_or_del(new /obj/item/claymore/bastard(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat/gauntlet/steel(new_character), slot_gloves)
					new_character.updateStatPanel()
					new_character.create_kg()
					spawn(5)
				...
				if("LadyVandenberg")
					...
					new_character.equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/pistol/ml23/gold(new_character), slot_belt)
					new_character.updateStatPanel()
					new_character.create_kg()
				...
				if("LudrukGuard")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/jackboots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/legcuffs/bola(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/handcuffs(new_character), slot_l_store)
					var/swordtype = pick("club","mace","spear")
					switch(swordtype)
						if("club")
							new_character.equip_to_slot_or_del(new /obj/item/melee/classic_baton/club(new_character), slot_belt)
							new_character.my_skills.change_skill(SKILL_SWING, 3)
						if("mace")
							new_character.equip_to_slot_or_del(new /obj/item/melee/classic_baton/mace(new_character), slot_belt)
							new_character.my_skills.change_skill(SKILL_SWING, 3)
						if("spear")
							new_character.equip_to_slot_or_del(new /obj/item/claymore/spear(new_character), slot_r_hand)
							new_character.my_skills.change_skill(SKILL_STAFF, 3)*/
				...
				if("Mortician")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/boots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/mortus(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/chisel(new_character), slot_r_store)
					new_character.equip_to_slot_or_del(new /obj/item/spacecash/c10(new_character), slot_l_store)
					new_character.equip_to_slot_or_del(new /obj/item/cell/web/empty(new_character), slot_back2)
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_l_hand)
					new_character.add_perk(/datum/perk/ref/strongback)
				...
				if("Tiamat")
					...
					for(var/obj/effect/landmark/L in landmarks_list)
						if (L.name == "migstart")
							new_character.forceMove(L.loc)
					hasrolled = TRUE
					to_chat(new_character, "<span class='objectivesbig'> You're a Tiamat</span>")
					...
					new_character.my_stats.change_stat(STAT_DX , 0)
					new_character.my_stats.change_stat(STAT_HT , 3)
					new_character.old_job = "Tiamat"
					new_character.job = "Tiamat"
					new_character.province = "Ravenheart"
					new_character.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security(new_character), slot_w_uniform)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/jackboots(new_character), slot_shoes)
					...
					new_character.equip_to_slot_or_del(new /obj/item/gun/energy/taser/leet/sparq(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_l_hand)
					new_character.add_perk(/datum/perk/ref/strongback)
					new_character.add_perk(/datum/perk/morestamina)
					new_character.add_perk(/datum/perk/heroiceffort)
				...
				if("Inquisitor1")
					...
					for(var/obj/effect/landmark/L in landmarks_list)
						if (L.name == "InquisitorLate")
							new_character.forceMove(L.loc)
					new_character.equip_to_slot_or_del(new /obj/item/card/id/churchkeeper(new_character), slot_wear_id)
					...
					new_character.equip_to_slot_or_del(new /obj/item/gun/energy/taser/leet/noctis(new_character), slot_belt)
					new_character.equip_to_slot_or_del(new /obj/item/storage/backpack/minisatchelchurch(new_character), slot_back)
					new_character.equip_to_slot_or_del(new /obj/item/cell/crap/leet/noctis(new_character), slot_l_store)
					new_character.equip_to_slot_or_del(new /obj/item/melee/baton(new_character), slot_r_hand)
					new_character.equip_to_slot_or_del(new /obj/item/handcuffs(new_character), slot_r_store)
					/obj/item/handcuffs
					new_character.old_job = "Inquisitor"
					new_character.job = "Inquisitor"
					if(new_character.wear_id)
						var/obj/item/card/id/R = new_character.wear_id
				...
				if("Practicus1")
					...
					new_character.equip_to_slot_or_del(new /obj/item/cell/crap/leet/noctis(new_character), slot_l_store)
					new_character.equip_to_slot_or_del(new /obj/item/handcuffs(new_character), slot_r_store)
					new_character.equip_to_slot_or_del(new /obj/item/melee/telebaton(new_character), slot_r_hand)
				...
				if("Bandit")
					...
					new_character.equip_to_slot_or_del(new /obj/item/clothing/under/common/outlaw(new_character), slot_w_uniform)
					new_character.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/jackboots(new_character), slot_shoes)
					new_character.equip_to_slot_or_del(new /obj/item/kitchen/utensil/knife/dagger(new_character), slot_r_store)
					new_character.equip_to_slot_or_del(new /obj/item/flame/torch/on(new_character), slot_r_hand)
					new_character.add_perk(/datum/perk/ref/strongback)
					new_character.terriblethings = TRUE
					for(var/obj/effect/landmark/L in landmarks_list)
					...
					switch(banditweapon)
						if("sword")
							new_character.equip_to_slot_or_del(new /obj/item/claymore/falchion(new_character), slot_belt)
							new_character.equip_to_slot_or_del(new /obj/item/shield/wood(new_character), slot_l_hand)
						if("spear")
							new_character.equip_to_slot_or_del(new /obj/item/claymore/spear(new_character), slot_l_hand)
						if("club")
							new_character.equip_to_slot_or_del(new /obj/item/melee/classic_baton/smallclub(new_character), slot_belt)
							new_character.equip_to_slot_or_del(new /obj/item/shield/wood(new_character), slot_l_hand)
						if("mace")
							new_character.equip_to_slot_or_del(new /obj/item/melee/classic_baton/club/bronze(new_character), slot_l_hand)
				...
				if("Nephi")
					...
					new_character.equip_to_slot_or_del(new /obj/item/melee/golfclub(new_character), slot_belt)

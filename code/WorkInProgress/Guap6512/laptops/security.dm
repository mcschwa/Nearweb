/obj/item/device/laptop/secure_data//TODO:SANITY
...
/obj/item/device/laptop/secure_data/attackby(obj/item/O as obj, user as mob)
...
/obj/item/device/laptop/secure_data/attack_ai(mob/user as mob)
	return attack_self(user)

/obj/item/device/laptop/secure_data/attack_paw(mob/user as mob)
	return attack_self(user)

//Someone needs to break down the dat += into chunks instead of long ass lines.
/obj/item/device/laptop/secure_data/attack_self(mob/user as mob)
	if(..())
		return
	if (src.z > 5)
...
What a mess.*/
/obj/item/device/laptop/secure_data/Topic(href, href_list)
	if(..())
		return
...
//RECORD CREATE
			...
			if ("New Record (General)")
				...
				G.fields["rank"] = "Savage"
				G.fields["real_rank"] = "Savage"
				G.fields["sex"] = "Male"
				...
				switch(href_list["field"])
					...
					if("criminal")
						if (istype(active2, /datum/data/record))
							...
							temp += "</ul>"
					if("rank")
						var/list/L = list( "Head of Personnel", "Observer", "AI" )

...
proc/setup_jobs()
	...
	JOB.equipment_shoes = list(/obj/item/clothing/shoes/lw/brown,/obj/item/clothing/shoes/lw/brown,/obj/item/clothing/shoes/lw/black)
...
proc/dress_for_job_default(var/mob/living/carbon/human/employee as mob, var/job_alias)
	...
	if(JOB)
		...
		/*
	src.equip_to_slot_or_del(new /obj/item/storage/backpack/industrial (src), slot_back)
	src.equip_to_slot_or_del(new /obj/item/storage/box/engineer(src), slot_in_backpack)
	...
	src.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/brown(src), slot_shoes)
	src.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/hardhat(src), slot_head)
	src.equip_to_slot_or_del(new /obj/item/storage/utilitybelt/full(src), slot_l_hand) //currently spawns in hand due to traitor assignment requiring a PDA to be on the belt. --Errorage

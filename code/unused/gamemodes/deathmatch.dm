		...
		for(var/mob/living/carbon/human/M in mobs)
			spawn()
				if(M.client)
					...
					M.equip_to_slot_or_del(new /obj/item/clothing/shoes/lw/black(M), slot_shoes)
					...
					M.equip_to_slot_or_del(new /obj/item/gun/energy/pulse_rifle(M), slot_l_hand)
					M.equip_to_slot_or_del(new /obj/item/m_pill/cyanide(M), slot_l_store)
					M.equip_to_slot_or_del(new /obj/item/flashbang(M), slot_r_store)

...
/proc/can_operate(mob/living/carbon/M)
	...
	(M.buckled && (M.lying || M.weakened || M.stunned || M.paralysis || M.sleeping || M.stat))
...
#define DELTA_CALC max(((max(world.tick_usage, world.cpu) / 100) * max(1,1)), 1)
...
var/datum/debugFileOutput/debugFileOutput = new
